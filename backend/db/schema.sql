...
ALTER TABLE outcome_data ADD COLUMN IF NOT EXISTS tp600_within_5m   BOOLEAN DEFAULT FALSE;
ALTER TABLE outcome_data ADD COLUMN IF NOT EXISTS tp600_within_10m  BOOLEAN DEFAULT FALSE;
ALTER TABLE outcome_data ADD COLUMN IF NOT EXISTS tp700_within_5m   BOOLEAN DEFAULT FALSE;
ALTER TABLE outcome_data ADD COLUMN IF NOT EXISTS tp700_within_10m  BOOLEAN DEFAULT FALSE;
ALTER TABLE outcome_data ADD COLUMN IF NOT EXISTS tp800_within_5m   BOOLEAN DEFAULT FALSE;
ALTER TABLE outcome_data ADD COLUMN IF NOT EXISTS tp800_within_10m  BOOLEAN DEFAULT FALSE;
ALTER TABLE outcome_data ADD COLUMN IF NOT EXISTS tp900_within_5m   BOOLEAN DEFAULT FALSE;
ALTER TABLE outcome_data ADD COLUMN IF NOT EXISTS tp900_within_10m  BOOLEAN DEFAULT FALSE;
ALTER TABLE outcome_data ADD COLUMN IF NOT EXISTS tp990_within_5m   BOOLEAN DEFAULT FALSE;
ALTER TABLE outcome_data ADD COLUMN IF NOT EXISTS tp990_within_10m  BOOLEAN DEFAULT FALSE;
-- SL levels 擴充
